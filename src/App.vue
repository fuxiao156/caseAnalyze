      ...
      "characters": [
        {
          ...
          "personality": "对抗/偏执",
          "drivers": [
            { "label": "老有所养", "value": 0.95, "desc": "核心动力是因丧失劳动能力后，对未来生活保障的极端渴望。" },
            { "label": "公平补偿", "value": 0.70, "desc": "认为此前的协议未涵盖误工费，是对其劳动价值的剥削。" }
          ],
          "biases": [
        ...
        },
        {
          ...
          "personality": "理性/僵化",
          "drivers": [
            { "label": "成本控制", "value": 0.85, "desc": "严格执行企业法律成本精算，防止出现“法外补偿”的先例。" },
            { "label": "合规避责", "value": 0.90, "desc": "坚持以已签协议为边界，规避可能的审计或合规风险。" }
          ],
          "biases": [
